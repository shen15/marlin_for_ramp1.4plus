...
#define DELTA_DIAGONAL_ROD 234.00
...
#define MANUAL_Z_HOME_POS 239.4  // For delta: Distance between nozzle and print surface after homing.

#define AUTOLEVEL_GRID (15.0)  // Distance between autolevel Z probing points, should be less than print surface radius/3.
#define SAVE_G29_CORRECTION_MATRIX
//// MOVEMENT SETTINGS
#define NUM_AXIS 4 // The axis order in all axis related arrays is X, Y, Z, E
#define HOMING_FEEDRATE {50*60, 50*60, 50*60, 0}  // set the homing speeds (mm/min)

#define Z_PROBE_OFFSET {0, 0, 5, 0}  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 85}
#define DEFAULT_MAX_FEEDRATE          {300, 300, 300, 300}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {3000 ,3000,3000,6000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
